...
const SplitPane = ({ left, right }) => {
    ...
    const handleMouseMove = useCallback((e) => {
        ...
        requestAnimationFrame(() => {
            ...
            const newSplitPosition = Math.min(Math.max((mousePosition / containerWidth) * 100, 15), 60);
    ...
    return (_jsxs("div", { className: `split-pane-container ${isDragging ? 'dragging' : ''} ${isChatCollapsed ? 'chat-collapsed' : ''}`, ref: splitContainerRef, children: [_jsx("div", { className: "split-pane-left", style: {
                ...
                }, children: left }), _jsx("div", { className: "split-pane-divider", ref: dividerRef, style: {
                    display: isChatCollapsed ? 'none' : 'block',
                    width: isChatCollapsed ? '0px' : '6px'
                } }), _jsx("div", { className: "split-pane-right", style: {
