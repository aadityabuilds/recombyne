...
exports.analyzePlasmidWithAI = exports.getPlasmidDataForAI = exports.convertNaturalLanguageToEntrezParams = void 0;
 ...
 */
const convertNaturalLanguageToEntrezParams = async (query) => {
    try {
...
exports.convertNaturalLanguageToEntrezParams = convertNaturalLanguageToEntrezParams;
/**
 ...
 */
const getPlasmidDataForAI = (store) => {
    try {
...
exports.getPlasmidDataForAI = getPlasmidDataForAI;
/**
...
const analyzePlasmidWithAI = async (store, userQuery, messageHistory = []) => {
    try {
        if (!OPENAI_API_KEY || OPENAI_API_KEY === 'your-openai-api-key-here') {
            throw new Error('OpenAI API key is not configured. Please add your API key to the .env.local file.');
        }
        // Get plasmid data if available
        const plasmidData = (0, exports.getPlasmidDataForAI)(store);
...
exports.analyzePlasmidWithAI = analyzePlasmidWithAI;
exports.default = {
    convertNaturalLanguageToEntrezParams: exports.convertNaturalLanguageToEntrezParams,
    getPlasmidDataForAI: exports.getPlasmidDataForAI,
    analyzePlasmidWithAI: exports.analyzePlasmidWithAI
};
